...
from .views import (
    ...
    ConnectAccountView, TransactionListView, ChargeListView, _BankAccountListView, _PaypalAccountListView
)
...
urlpatterns += [
    ...
    path('paypal-account-list/', _PaypalAccountListView.as_view(), name='_paypal-account-list'),
]